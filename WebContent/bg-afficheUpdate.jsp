  ...
  <tr>
    ...
    <td width="618" align="center" valign="top" bgcolor="#FFFFFF"> <br>
        ...
        <br>
		 ...
		 <form action="afficheAction.do?action=5&id=" onsubmit="return checkEmpty(afficheForm)">
          ...
          <tr>
            ...
            <td width="77%" bgcolor="#FFFFFF">
              <input name="id" type="hidden"  value="11"><input name="name" type="text" size="55" value="2017年国庆放假"></td>
          </tr>
          <tr>
            <td height="208"><div align="center">公告内容</div>              </td>
            <td bgcolor="#FFFFFF">
              <textarea name="content" cols="45" rows="13" class="textarea">2017年国庆放假啦...</textarea></td>
          </tr>
        </table><br>  
