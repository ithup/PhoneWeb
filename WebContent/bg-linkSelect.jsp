...
<table width="788" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <table width="90%"  border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="CCCCCC">
        ...
        <tr bgcolor="#FFFFFF">
          ...
          <td><div align="center">搜狐</div></td>
          <td><div align="center">http://www.sohu.com</div></td>
          <td><div align="center"><a href="linkAction.do?action=4&id=">删除</a></div></td>
  </tr>
      </table>
	  <br>
	  <table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
        <tr align="center">
          <td width="13%">共为4页</td>
          <td width="16%">共有34条记录</td>
          <td width="14%">当前为第3页</td>
          <td width="19%">
      上一页

        <a href="linkAction.do?action=0&i=">上一页</a></td>

          <td width="18%">
            下一页
             
              <a href="linkAction.do?action=0&i=">下一页</a></td>
